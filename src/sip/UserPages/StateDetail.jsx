...
const StateDetail = () => {
  ...
  useEffect(() => {
    const getState = async () => {
      const res = await userRequest.get(`/state/find/${id}`);
      setStateInfo(res.data);
      console.log(res.data.sip);
    };
    getState();
  }, [id]);
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await userRequest.put(`/state/${id}`, state);
      ...
      <Wrapper>
        <WrapperLeft>
          ...
          <WrapperLeftBody>
            <WrapperBodyContainer>
              ...
              <WrapperInfoValue>{stateInfo.name}</WrapperInfoValue>
            </WrapperBodyContainer>
            <WrapperBodyContainer>
              <WrapperInfoKey>Programmes: </WrapperInfoKey>
              <WrapperInfoValue>
                <TradeAreaDiv>
                  {stateInfo?.sip?.map((t) => (
            ...
            <WrapperBodyContainer>
              <WrapperInfoKey>Trade Areas: </WrapperInfoKey>
              <WrapperInfoValue>
                <TradeAreaDiv>
                  {stateInfo?.tradeArea?.map((t) => (
                    <TradeAreaP>{t}</TradeAreaP>
                  ))}
                </TradeAreaDiv>
              </WrapperInfoValue>
        ...
        <WrapperRight>
          ...
          <WrapperFormContainer>
            <Form>
              <Label>Name</Label>
              <Input defaultValue={stateInfo.name} onChange={handleChange} />
